    ...
    stages {
        ...
        stage('Init') {
            ...
            steps {
                ...
                git url: 'https://github.com/universalmensch/swe_album', branch: 'main', poll: true
            }
        }
